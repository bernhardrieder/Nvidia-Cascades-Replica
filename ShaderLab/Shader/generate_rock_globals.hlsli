...
float4 inv_voxelDim = float4(1.0 / 96.0, 1.0 / 256.0, 1.0 / 96.0, 0); // initial value must be literal!
//float4 inv_voxelDimMinusOne = float4(1.0 / voxelDimMinusOne, 0);
float4 inv_voxelDimMinusOne = float4(1.0 / 95.0, 1.0 / 256.0, 1.0 / 95.0, 0); // initial value must be literal!